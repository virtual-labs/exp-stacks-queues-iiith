...
function drawQueueStructure(ctx) {
  ...
  if (headhere >= -1 && tailhere >= -1) {
    ...
    ctx.fillStyle = "#a4c652";
    ctx.fillRect(
      queueexercise_artefact.rectStartx +
        headhere * queueexercise_artefact.rectWidth +
        headhere * queueexercise_artefact.arrayDist,
      queueexercise_artefact.rectStarty,
      queueexercise_artefact.rectWidth,
      queueexercise_artefact.rectHeight
    );
    for (var i = headhere + 1; i < tailhere; i++) {
      ctx.fillStyle = "#288ec8";
      ctx.fillRect(
        queueexercise_artefact.rectStartx +
          i * queueexercise_artefact.rectWidth +
          i * queueexercise_artefact.arrayDist,
        queueexercise_artefact.rectStarty,
        queueexercise_artefact.rectWidth,
        queueexercise_artefact.rectHeight
      );
    ...
    ctx.fillRect(
      queueexercise_artefact.rectStartx +
        tailhere * queueexercise_artefact.rectWidth +
        tailhere * queueexercise_artefact.arrayDist,
      queueexercise_artefact.rectStarty,
      queueexercise_artefact.rectWidth,
      queueexercise_artefact.rectHeight
    );
...
function writeNumbers(ctx) {
  ...
  if (headhere > -1 && valueshere.length > 0 && tailhere > -1) {
    for (var i = headhere; i <= tailhere; i++) {
      ...
      txtX =
        ...
        i * queueexercise_artefact.rectWidth +
        i * queueexercise_artefact.arrayDist +
        (queueexercise_artefact.rectWidth - txtWidth) / 2;
      txtY =
        queueexercise_artefact.rectStarty +
        queueexercise_artefact.rectHeight -
        (queueexercise_artefact.rectHeight - queueexercise_artefact.txtSize) /
          2;
  ...
  if (headhere > -1) {
    ...
    ctx.moveTo(
      queueexercise_artefact.hArrowStartx + relativeArrowPos,
      queueexercise_artefact.hArrowStarty
    );
    ctx.lineTo(
      queueexercise_artefact.hArrowEndx + relativeArrowPos,
      queueexercise_artefact.hArrowEndy
    );
    ctx.strokeStyle = "#a4c652";
    ctx.lineWidth = 1.5;
    ctx.stroke();
    ...
    ctx.lineTo(
      queueexercise_artefact.hArrowStartx +
        relativeArrowPos -
        queueexercise_artefact.hArrowHeadOffsetx,
      queueexercise_artefact.hArrowStarty -
        queueexercise_artefact.hArrowHeadOffsety
    );
    ctx.strokeStyle = "#a4c652";
    ctx.stroke();
    ...
    ctx.fillText(
      htxt,
      queueexercise_artefact.hArrowEndx + relativeArrowPos - htxtWidth / 2,
      queueexercise_artefact.hArrowEndy - queueexercise_artefact.hArrowHeady
    );
  ...
  if (tailhere > -1) {
    ...
    ctx.moveTo(
      queueexercise_artefact.tArrowStartx + relativeArrowPos,
      queueexercise_artefact.tArrowStarty
    );
    ctx.lineTo(
      queueexercise_artefact.tArrowEndx + relativeArrowPos,
      queueexercise_artefact.tArrowEndy
    );
    ...
    ctx.lineTo(
      queueexercise_artefact.tArrowStartx +
        relativeArrowPos -
        queueexercise_artefact.tArrowHeadOffsetx,
      queueexercise_artefact.tArrowStarty +
        queueexercise_artefact.tArrowHeadOffsety
    );
    ctx.strokeStyle = "#7bde3d";
    ctx.stroke();
    ...
    ctx.fillText(
      ttxt,
      queueexercise_artefact.tArrowEndx + relativeArrowPos - ttxtWidth / 2,
      queueexercise_artefact.tArrowEndy + queueexercise_artefact.tArrowTaily
    );
  ...
  if (
    ...
    if (value === "" || value === null) return;
      ...
      document.getElementById(
        ...
        ", "
      )}]<br>${value} is dequeued from queueA and enqueued to queueB`;
  ...
  if (
    ...
    if (value === "" || value === null) return;
      ...
      document.getElementById(
        ...
        ", "
      )}]<br>${value} is dequeued from queueB and enqueued to queueA`;
      writeNumbers(queueA_canvas);
      writeNumbers(queueB_canvas);
    }
  }
...
function reset() {
  ...
  queueexercise_artefact.resultArray =
    queueexercise_artefact.reset_array.slice();
  document.getElementById(
    "ins"
  ).innerHTML = `<b>Your output:</b> [${queueexercise_artefact.sol.join(
    ", "
  )}]<br><b>Execution is reset</b>`;
...
function generateQuestion() {
  txtq1 =
    "A set of elements are given in Queue A. With the help of queue B, deque the elements in ASCENDING order.";
  txtq2 =
    "A set of numbers are given in Queue A. With the help of queue B, deque the elements in DESCENDING order.";
...
function handlers() {
  ...
  document.getElementById("checkButton-queue").onclick = function () {
    check();
  };
  document.getElementById("enqueue-to-A").onclick = function () {
    enqueuetoa();
  };
  document.getElementById("enqueue-to-B").onclick = function () {
    enqueuetob();
  };
  document.getElementById("dequeue-button").onclick = function () {
    dequeueA();
  };
  document.getElementById("dequeue-buttonB").onclick = function () {
    dequeueB();
  };
}
