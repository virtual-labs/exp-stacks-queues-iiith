...
class stack_array {
  constructor() {
    ...
    this.arrowTopy = 25;
    this.values = [];
    this.stackType = null; // 'int' or 'float'
  }
}
...
function drawArray() {
  ctx.beginPath();
  ctx.rect(
    stackarray_artefact.rectStartx,
    stackarray_artefact.rectStarty,
    stackarray_artefact.rectWidth * stackarray_artefact.rectNo +
      stackarray_artefact.lineNo * stackarray_artefact.lineDist,
    stackarray_artefact.rectHeight
  );
  ...
  for (var i = 1; i < stackarray_artefact.rectNo; i++) {
    ctx.rect(
      stackarray_artefact.rectStartx +
        i * stackarray_artefact.rectWidth +
        (i - 1) * stackarray_artefact.lineDist,
      stackarray_artefact.rectStarty,
      stackarray_artefact.lineDist,
      stackarray_artefact.rectHeight
    );
    ctx.strokeStyle = "#288ec8";
    ctx.stroke();
  ...
  for (var i = 0; i < stackarray_artefact.rectNo; i++) {
    ...
    txtXIndex =
      stackarray_artefact.indexPosx +
      i * stackarray_artefact.rectWidth +
      (stackarray_artefact.rectWidth - txtWidthIndex) / 2 +
      i * stackarray_artefact.lineDist;
...
function writeNumbers() {
  ...
  if (stackarray_artefact.topOfStack > -1) {
    ...
    ctx.fillRect(
      stackarray_artefact.rectStartx +
        (stackarray_artefact.values.length - 1) *
          stackarray_artefact.rectWidth +
        (stackarray_artefact.values.length - 1) * stackarray_artefact.lineDist,
      stackarray_artefact.rectStarty,
      stackarray_artefact.rectWidth,
      stackarray_artefact.rectHeight
    );
  ...
  for (var i = 0; i < stackarray_artefact.values.length; i++) {
    ...
    ctx.fillStyle = "white";
    let txt;
    if (stackarray_artefact.stackType === "float") {
      txt = parseFloat(stackarray_artefact.values[i]).toFixed(1);
    } else {
    ...
    txtX =
      stackarray_artefact.rectStartx +
      i * stackarray_artefact.rectWidth +
      (stackarray_artefact.rectWidth - txtWidth) / 2 +
      i * stackarray_artefact.lineDist;
    txtY =
      stackarray_artefact.rectStarty +
      stackarray_artefact.rectHeight -
      (stackarray_artefact.rectHeight - stackarray_artefact.txtSize) / 2;
  ...
  if (stackarray_artefact.topOfStack > -1) {
    var relativeArrowPos =
      stackarray_artefact.topOfStack * stackarray_artefact.rectWidth +
      (stackarray_artefact.values.length - 1) * stackarray_artefact.lineDist;

    ctx.beginPath();

    ctx.moveTo(
      stackarray_artefact.arrowStartx + relativeArrowPos,
      stackarray_artefact.arrowStarty
    );
    ctx.lineTo(
      stackarray_artefact.arrowEndx + relativeArrowPos,
      stackarray_artefact.arrowEndy
    );
    ...
    ctx.lineTo(
      stackarray_artefact.arrowStartx +
        relativeArrowPos -
        stackarray_artefact.arrowHeadOffsetx,
      stackarray_artefact.arrowStarty + stackarray_artefact.arrowHeadOffsety
    );
    ctx.strokeStyle = "#a4c652";
    ctx.stroke();
    ...
    ctx.fillText(
      txt,
      stackarray_artefact.arrowEndx + relativeArrowPos - txtWidth / 2,
      stackarray_artefact.arrowEndy + stackarray_artefact.arrowTopy
    );
...
function onpush() {
  var value = document.getElementById("numbers-stackarray").value.trim();
  if (stackarray_artefact.values.length >= stackarray_artefact.rectNo) {
    ...
    document.getElementById("ins").innerHTML =
      "Please enter an element in the textbox that you want to <b>PUSH</b> into the stack";
  } else {
    ...
    if (!isNumber) {
      ...
      // If stack is empty, set type
      if (stackarray_artefact.stackType === null) {
        stackarray_artefact.stackType = isInt ? "int" : "float";
      }
      // Strictly enforce type for all subsequent pushes
      if (stackarray_artefact.stackType === "int") {
        // Only allow pure integers (no floats, no "2.0")
        if (!isInt) {
          document.getElementById(
            "ins"
          ).innerHTML = `Stack only allows <b>integer</b> values. Please enter a valid integer.`;
...
function onclear() {
  ...
  stackarray_artefact.stackType = null;
  document.getElementById("ins").innerHTML =
    "Stack is cleared <br>  Index of the top of stack : -1";
  drawArray();
}
function handlers() {
